        ...
        const promise = new Promise((resolutionFunc, rejectionFunc)=>{
            ...
            */ if (response.ok) {
                    ...
                    rejectionFunc({
                        ...
                        description: "Are you sure that the URL is correct? The URL is usually mainnet = http://127.0.0.1:8766 and testnet =  http://127.0.0.1:18766"
                    });
                });
            } catch (e) {
...
async function $c3f6c693698dc7cd$var$postData(url = "", data = {}, username, password) {
    ...
    else if ($c3f6c693698dc7cd$require$Buffer) base64Credentials = $c3f6c693698dc7cd$require$Buffer.from(`${username}:${password}`).toString("base64");
...
export {$c3f6c693698dc7cd$export$eb94c228b080d168 as getRPC, $ebb7c8e52e3397d2$export$e13b82b2b0368a6a as methods};
